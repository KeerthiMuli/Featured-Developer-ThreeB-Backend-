...
public class BasicConfiguration extends WebSecurityConfigurerAdapter {
  ...
  public void configure(HttpSecurity http) throws Exception {
    http.csrf()
        ...
        .antMatchers(HttpMethod.POST, "/developers/create").permitAll()
        .antMatchers(HttpMethod.PUT, "/developers/update/{developerId}").permitAll()
        .antMatchers(HttpMethod.DELETE, "/developers/delete/{developerId}").permitAll()
